...
<script type="text/javascript">
  function comservico() {
    ...
    $('#cadastrosenha').append('<label for="senha" class="form-control">Digite a sua pergunta secreta </label><br />')
    $('#cadastrosenha').append('<input type="text" name="pergunta" class="form-control input-group-lg"  id="pergunta" value="" /><br />')
    $('#cadastrosenha').append('<label for="senha" class="form-control">Digite a sua resposta </label><br />')
    ...
    $('#cadastrosenha').append('<button class="btn btn-primary" type="submit" >Salvar</button>')
