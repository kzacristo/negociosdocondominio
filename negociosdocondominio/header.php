        ...
        <nav class="navbar navbar-expand-lg navbar-dark" >
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
              <ul class="navbar-nav">
              <li class="nav-item">  <a class="nav-link" href="busca.php"><font color="black">Buscar</font></a> </li>
              <li class="nav-item">  <a class="nav-link" href="cadastro.php"><font color="black">Cadastro Morador</font></a> </li>
              <li class="nav-item">  <a class="nav-link" href="cadastro-servicos.php"><font color="black">Cadastro Serviços</font></a> </li>
              <li class="nav-item">  <a class="nav-link" href="perfil.php"><font color="black">Perfil</font></a> </li>
